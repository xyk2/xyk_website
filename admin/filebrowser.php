		...
		foreach ($filesSorted as $upload) {
			...
			if ($type == 'images') {
				if ($upload['type'] == i18n_r('IMAGES') .' Images') {
					...
					#}
					$thumbnailLink = '<span>&nbsp;&ndash;&nbsp;&nbsp;</span><a href="javascript:void(0)" onclick="submitLink('.$CKEditorFuncNum.',\''.'http://d30cz35xum7wy8.cloudfront.net/'.$subDir.$upload['name'].'\')">'.'CloudFront CDN'.'</a>';
				}
				else { continue; }
			}
