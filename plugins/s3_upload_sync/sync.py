...
if(contents == "NEW FILE/DIRECTORY"):
	os.system("s3cmd sync --exclude '*_cached_1_month/*' --exclude '*_gzip_1_month/*' /home/xyk/public/data/uploads/ s3://oldblog --add-header 'Cache-Control: max-age=604800'-v")
	...
	os.system("s3cmd sync --delete-removed /home/xyk/public/data/uploads/ s3://oldblog")
